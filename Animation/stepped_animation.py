...
ORIGIN = [13950.0, 12336.0, 12805.0]
...
# show color bar/color legend
elevation1Display.SetScalarBarVisibility(renderView1, False)
...
zoom_in_out.Position = initial_camera_position
zoom_in_out.KeyTime = ZOOM_IN_OUT_TIME / END_TIME
zoom_in_out.FocalPoint = DAM_POS
zoom_in_out.ViewUp = initial_view_up
zoom_in_out.ParallelScale = 14000
...
rotate_around_end = [13996.719225409519, 18879.075305891896, 11541.435659649702]

rotate_around_quake = CameraKeyFrame()
rotate_around_quake.Position = initial_camera_position
rotate_around_quake.KeyTime = ROTATE_AROUND_QUAKE_TIME / END_TIME
rotate_around_quake.FocalPoint = DAM_POS
rotate_around_quake.ViewUp = [0.0, 1.0, 0.3]
rotate_around_quake.ParallelScale = 14000
rotate_around_quake.PositionPathPoints = initial_camera_position + [
    13856.348220902946, 14909.402531057774, 18484.433340541807,
    14261.088092672915, 17779.979955407394, 21668.830742773418,
    17909.20499942337, 23049.163965343057, 11515.098905902763,
    16960.748021833948, 22161.4085150855, 6295.130849191481,
    13933.790983279498, 20135.45317611746, 2346.863403952785,
    3014.085408959708, 20258.03838032848, 297.64755854028806,
    -3050.2460324315593, 20279.987382896616, 7049.672426511784,
    216.09251699802147, 20238.15314749862, 15793.461352789647,
    11585.166148978373, 20280.048960339995, 15545.394640106424,
    14616.762806808418, 20202.92676046738, 6963.282620773434,
    13535.048982581504, 20451.379687757137, 5010.043065159374,
    10805.683740216129, 20660.675875080353, 2312.1263873734547,
    3022.891161807346, 21440.10021370563, 2430.4716292375515,
    -1239.1337676842813, 22949.363693724936, 9757.347114226726,
    3863.7926355013897, 22257.02611163997, 15130.05130079828,
    11192.827897126355, 20105.617038329376, 13510.44994353468,
    13190.414559766441, 21568.46167279911, 7658.716293545554,
    15224.307970273878, 24088.410971867357, 1908.5613595401205,
    17468.65232435598, 23089.81898693792, 1329.676176499326,
] + rotate_around_end
rotate_around_quake.FocalPathPoints = DAM_POS + [7000, 12000, 7000] + DAM_POS
rotate_around_quake.ClosedPositionPath = 0

show_dam_front = CameraKeyFrame()
show_dam_front.KeyTime = SHOW_DAM_FROM_TIME / END_TIME
show_dam_front.FocalPoint = DAM_POS
show_dam_front.ViewUp = [0.0, 1.0, 0.3]
show_dam_front.ParallelScale = 14000
show_dam_front.PositionPathPoints = rotate_around_end + [
    11898.734969870904, 18247.50592487779, 12189.797418313048,
    12464.338549597927, 15212.181147313378, 14835.035646407785,
    13800.154796289036, 13496.793046637787, 14825.848905099809,
    DAM_POS[0], DAM_POS[1] + 200, DAM_POS[2] + 500
]
show_dam_front.FocalPathPoints = DAM_POS
show_dam_front.ClosedPositionPath = 0

# create a key frame
rest_frame = CameraKeyFrame()
rest_frame.KeyTime = REST_FRAME_TIME / END_TIME
rest_frame.Position = [DAM_POS[0], DAM_POS[1], DAM_POS[2] + 500]
rest_frame.FocalPoint = DAM_POS
rest_frame.ViewUp = [0.0, 1.0, 0.3]
rest_frame.ParallelScale = 14000



# initialize the animation track
cameraAnimationCue1.Mode = 'Path-based'
cameraAnimationCue1.KeyFrames = [zoom_in_out, rotate_around_quake, show_dam_front, rest_frame]

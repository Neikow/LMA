...
resultsxmfDisplay.SetScalarBarVisibility(renderView1, False)
...
# create a key frame
keyFrame9026 = CameraKeyFrame()
keyFrame9026.Position = [34640.44666888083, 43114.68649436659, 46740.55142638823]
keyFrame9026.FocalPoint = [13949.99999999995, 12546.642578125027, 12804.999999999965]
keyFrame9026.ViewUp = [0, 1, 0]
keyFrame9026.ParallelScale = 19000.28458824738
keyFrame9026.PositionPathPoints = [
    24519.972261181014, 17862.630924030018, 4137.641151048168,
    4713.757845464442, 17243.543983708507, 3400.0467203267035,
    8962.836127685328, 17703.630771768727, 24028.58110543052,
    15871.71375965518, 18568.201584758688, 11043.482561385983,
    12821.851336541364, 17566.218165554907, 12407.777519145944,
    14308.941730162882, 16896.533339972146, 13794.752684531064,
    15009.837608496238, 17297.8157363112, 12548.335618449722,
    12752.342974234192, 17203.32792168965, 10791.05568856654,
    13264.380283158693, 16850.261546772927, 23035.959610982725,
    24067.963376590822, 16697.048854227793, 22023.81450158805
    ]
keyFrame9026.FocalPathPoints = [13950.0, 13520.4, 12805.0]
keyFrame9026.ClosedPositionPath = 1

# create a key frame
keyFrame9027 = CameraKeyFrame()
keyFrame9027.KeyTime = 1.0
keyFrame9027.Position = [34640.44666888083, 43114.68649436659, 46740.55142638823]
keyFrame9027.FocalPoint = [13949.99999999995, 12546.642578125027, 12804.999999999965]
keyFrame9027.ViewUp = [0, 1, 0]
keyFrame9027.ParallelScale = 19000.28458824738


# initialize the animation track
cameraAnimationCue1.Mode = 'Path-based'
cameraAnimationCue1.KeyFrames = [keyFrame9026, keyFrame9027]
...
animationScene1.NumberOfFrames = NUM_IMAGES
...
for x in range(NUM_IMAGES):
    filename = path + '/orbit_animation_' + str(x).rjust(4, '0') + '.png'

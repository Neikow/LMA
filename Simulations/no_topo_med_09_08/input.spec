...
snapshots {
    ...
    deselect all;
select box = -1.0 12619.0 -1.0 27901.0 12981.0 25616.0;
select box = 27899.0 -1.0 -1.0 1.0 12981.0 25616.0;
select box = -1.0 -1.0 -1.0 1.0 12981.0 25616.0;
select box = -1.0 -1.0 25614.0 27901.0 12981.0 1.0;
select box = -1.0 -1.0 -1.0 27901.0 12981.0 1.0;

...
snapshots {
    ...
    deselect all;
select box = -101.0 1447.5 -101.0 7301.0 3856.5 4986.0;
select box = 7199.0 -101.0 -101.0 -99.0 3856.5 5086.0;
select box = -101.0 -101.0 -101.0 101.0 3856.5 5186.0;
select box = -101.0 -101.0 4884.0 7401.0 3856.5 101.0;
select box = -101.0 -101.0 -101.0 7401.0 3856.5 101.0;

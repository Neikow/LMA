...
snapshots {
    ...
    deselect all;
select box = -1.0 11847.5 -1.0 27901.0 14056.5 25616.0;
select box = 27899.0 -1.0 -1.0 1.0 14056.5 25616.0;
select box = -1.0 -1.0 -1.0 1.0 14056.5 25616.0;
select box = -1.0 -1.0 25614.0 27901.0 14056.5 1.0;
select box = -1.0 -1.0 -1.0 27901.0 14056.5 1.0;

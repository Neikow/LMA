#!/bin/sh
#SBATCH -J simulated_dam_curved_optimized_nearest_station_SEMMesh
#SBATCH -p skylake # partition utilisee
#SBATCH -n 1 # nombre de proc
#SBATCH -A b401 # compte de decompte
#SBATCH -t 80:00:00 # temps de timeout
#SBATCH -o ./%N.%x.out
#SBATCH -e ./%N.%x.err
# #SBATCH --mail-type=BEGIN,END
# #SBATCH --mail-user=vitaly.lysen@gmail.com
